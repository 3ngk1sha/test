...
exports.CONSOLE_CHANNEL_NAMESPACE = exports.CONSOLE_CHANNEL_NAME = void 0;
const config_1 = require("../../../config");
const types_1 = require("../../../setting/schemas/types");
exports.CONSOLE_CHANNEL_NAME = 'console-channel';
exports.CONSOLE_CHANNEL_NAMESPACE = 'console_channel';
exports.default = [
    {
        group: exports.CONSOLE_CHANNEL_NAMESPACE,
        label: 'allowed_domains',
        value: config_1.config.security.cors.allowOrigins.join(','),
