...
exports.NlpEntityController = void 0;
...
const nlp_entity_dto_1 = require("../dto/nlp-entity.dto");
const nlp_entity_service_1 = require("../services/nlp-entity.service");
let NlpEntityController = class NlpEntityController extends base_controller_1.BaseController {
    constructor(nlpEntityService) {
        super(nlpEntityService);
        this.nlpEntityService = nlpEntityService;
    }
    async create(createNlpEntityDto) {
    ...
    async findOne(id, populate) {
        ...
        if (!doc) {
            ...
            throw new common_1.NotFoundException(`NLP Entity with ID ${id} not found`);
        }
        return doc;
    }
    ...
    async updateOne(id, updateNlpEntityDto) {
        ...
        if (nlpEntity.builtin) {
            throw new common_1.MethodNotAllowedException(`Cannot update builtin NLP Entity ${nlpEntity.name}`);
        }
    ...
    async deleteOne(id) {
        ...
        if (nlpEntity.builtin) {
            throw new common_1.MethodNotAllowedException(`Cannot delete builtin NLP Entity ${nlpEntity.name}`);
        }
        const result = await this.nlpEntityService.deleteCascadeOne(id);
        if (result.deletedCount === 0) {
            this.logger.warn(`Failed to delete NLP Entity by id ${id}`);
            throw new common_1.InternalServerErrorException(`Failed to delete NLP Entity with ID ${id}`);
        }
        return result;
    }
    async deleteMany(ids) {
        ...
        if (deleteResult.deletedCount === 0) {
            this.logger.warn(`Unable to delete NLP entities with provided IDs: ${ids}`);
            throw new common_1.NotFoundException('NLP entities with provided IDs not found');
        }
        this.logger.log(`Successfully deleted NLP entities with IDs: ${ids}`);
        return deleteResult;
    }
};
exports.NlpEntityController = NlpEntityController;
__decorate([
    (0, nestjs_csrf_1.CsrfCheck)(true),
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [nlp_entity_dto_1.NlpEntityCreateDto]),
    __metadata("design:returntype", Promise)
], NlpEntityController.prototype, "create", null);
__decorate([
    (0, common_1.Get)('count'),
    __param(0, (0, common_1.Query)(new search_filter_pipe_1.SearchFilterPipe({ allowedFields: ['name', 'doc'] }))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NlpEntityController.prototype, "filterCount", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], NlpEntityController.prototype, "findOne", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)(pagination_query_pipe_1.PageQueryPipe)),
    __param(1, (0, common_1.Query)(populate_pipe_1.PopulatePipe)),
    __param(2, (0, common_1.Query)(new search_filter_pipe_1.SearchFilterPipe({ allowedFields: ['name', 'doc'] }))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Array, Object]),
    __metadata("design:returntype", Promise)
], NlpEntityController.prototype, "findPage", null);
__decorate([
    (0, nestjs_csrf_1.CsrfCheck)(true),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, nlp_entity_dto_1.NlpEntityCreateDto]),
    __metadata("design:returntype", Promise)
], NlpEntityController.prototype, "updateOne", null);
__decorate([
    (0, nestjs_csrf_1.CsrfCheck)(true),
    ...
    __metadata("design:returntype", Promise)
], NlpEntityController.prototype, "deleteOne", null);
__decorate([
    (0, nestjs_csrf_1.CsrfCheck)(true),
    (0, common_1.Delete)(''),
    (0, common_1.HttpCode)(204),
    ...
    __metadata("design:returntype", Promise)
], NlpEntityController.prototype, "deleteMany", null);
exports.NlpEntityController = NlpEntityController = __decorate([
    (0, common_1.UseInterceptors)(csrf_interceptor_1.CsrfInterceptor),
    (0, common_1.Controller)('nlpentity'),
    __metadata("design:paramtypes", [nlp_entity_service_1.NlpEntityService])
], NlpEntityController);
//# sourceMappingURL=nlp-entity.controller.js.map