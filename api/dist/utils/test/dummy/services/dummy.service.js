...
const base_service_1 = require("../../../generics/base-service");
const dummy_repository_1 = require("../repositories/dummy.repository");
let DummyService = class DummyService extends base_service_1.BaseService {
...
exports.DummyService = DummyService = __decorate([
    ...
    __metadata("design:paramtypes", [dummy_repository_1.DummyRepository])
], DummyService);
