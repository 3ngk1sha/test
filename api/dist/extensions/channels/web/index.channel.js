...
const base_web_channel_1 = __importDefault(require("./base-web-channel"));
const settings_1 = require("./settings");
let WebChannelHandler = class WebChannelHandler extends base_web_channel_1.default {
    constructor(settingService, channelService, logger, eventEmitter, i18n, subscriberService, attachmentService, messageService, menuService, websocketGateway) {
        super(settings_1.WEB_CHANNEL_NAME, settingService, channelService, logger, eventEmitter, i18n, subscriberService, attachmentService, messageService, menuService, websocketGateway);
    }
    getPath() {
        return __dirname;
    }
};
WebChannelHandler = __decorate([
...
exports.default = WebChannelHandler;
