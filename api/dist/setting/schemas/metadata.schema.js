...
exports.MetadataModel = exports.MetadataSchema = exports.Metadata = void 0;
...
let Metadata = class Metadata extends base_schema_1.BaseSchema {
};
...
__decorate([
    (0, mongoose_1.Prop)({ type: JSON, required: true }),
...
exports.MetadataModel = lifecycle_hook_manager_1.LifecycleHookManager.attach({
    name: Metadata.name,
    schema: mongoose_1.SchemaFactory.createForClass(Metadata),
});
