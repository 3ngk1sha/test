...
let TranslationRepository = class TranslationRepository extends base_repository_1.BaseRepository {
    constructor(model) {
        super(model, translation_schema_1.Translation);
        this.model = model;
    }
};
exports.TranslationRepository = TranslationRepository;
exports.TranslationRepository = TranslationRepository = __decorate([
