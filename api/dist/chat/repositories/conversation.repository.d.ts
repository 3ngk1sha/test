...
export declare class ConversationRepository extends BaseRepository<Conversation, ConversationPopulate, ConversationFull, ConversationDto> {
    readonly model: Model<Conversation>;
    constructor(model: Model<Conversation>);
